...
!function (t, e, i) {
    ...
    L.drawVersion = "0.4.14", L.Draw = {}, L.drawLocal = {
        draw: {
            toolbar: {
        ...
        _endPoint: function (e, i, o) {
            if (this._mouseDownOrigin) {
                var n = L.point(e, i).distanceTo(this._mouseDownOrigin), a = this._calculateFinishDistance(o.latlng);
                this.options.maxPoints > 1 && this.options.maxPoints == this._markers.length + 1 ? (this.addVertex(o.latlng), this._finishShape()) : a < 10 && L.Browser.touch ? this._finishShape() : Math.abs(n) < 9 * (t.devicePixelRatio || 1) && this.addVertex(o.latlng), this._enableNewMarkers()
            }
        ...
        _drawGuide: function (t, e) {
            var i, o, n, a = Math.floor(Math.sqrt(Math.pow(e.x - t.x, 2) + Math.pow(e.y - t.y, 2))),
                s = this.options.guidelineDistance, r = this.options.maxGuideLineLength, l = a > r ? a - r : s;
        ...
        options: {
            ...
            var i, o, n, a = this._getMiddleLatLng(t, e), s = this._createMarker(a);
        ...
        _createResizeMarker: function () {
            ...
            L.GeometryUtil.isVersion07x() ? radius = e.distanceTo(t) : radius = this._map.distance(e, t), this._shape.setRadius(radius), this._map._editTooltip.updateContent({
        ...
        L.GeometryUtil = L.extend(L.GeometryUtil || {}, {
            geodesicArea: function (t) {
                var e, i, o = t.length, n = 0, a = Math.PI / 180;
                if (o > 2) {
                ...
                var i = parseFloat(t).toFixed(e), o = L.drawLocal.format && L.drawLocal.format.numeric,
                    n = o && o.delimiters, a = n && n.thousands, s = n && n.decimal;
                if (a || s) {
                    var r = i.split(".");
        ...
        intersects: function () {
            ...
            var i = this._getProjectedPoints(), o = i ? i.length : 0, n = i ? i[o - 1] : null, a = o - 2;
        ...
        initialize: function (t) {
            ...
            var e, i, o, n, a = this._actionsContainer, s = this.getActions(t), r = s.length;
