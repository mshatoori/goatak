...
func NewHttp(app *App, address string) *air.Air {
	...
	srv.OPTIONS("/api/config", optionsHandler())
	srv.GET("/api/config", authMiddleware(app, getConfigHandler(app)))
	srv.PATCH("/api/config", authMiddleware(app, changeConfigHandler(app)))
	srv.OPTIONS("/api/types", optionsHandler())
	srv.GET("/api/types", authMiddleware(app, getTypes))
	srv.OPTIONS("/api/dp", optionsHandler())
	srv.POST("/api/dp", authMiddleware(app, getDpHandler(app)))
	srv.OPTIONS("/api/pos", optionsHandler())
	srv.GET("/api/pos", authMiddleware(app, getPosHandler(app)))
	srv.POST("/api/pos", authMiddleware(app, changePosHandler(app)))

	srv.OPTIONS("/ws", optionsHandler())
	srv.GET("/ws", authMiddleware(app, getWsHandler(app)))

	srv.GET("/api/unit", authMiddleware(app, getUnitsHandler(app)))
	srv.POST("/api/unit", authMiddleware(app, addItemHandler(app)))
	srv.OPTIONS("/api/unit", optionsHandler())
	srv.OPTIONS("/api/unit/:uid", optionsHandler())
	srv.OPTIONS("/api/message", optionsHandler())
	srv.GET("/api/message", authMiddleware(app, getMessagesHandler(app)))
	srv.POST("/api/message", authMiddleware(app, addMessageHandler(app)))
	srv.DELETE("/api/unit/:uid", authMiddleware(app, deleteItemHandler(app)))
	srv.POST("/api/unit/:uid/send/", authMiddleware(app, sendItemHandler(app)))

	srv.OPTIONS("/api/flows", optionsHandler())
	srv.GET("/api/flows", authMiddleware(app, getFlowsHandler(app)))
	srv.POST("/api/flows", authMiddleware(app, addFlowHandler(app)))
	srv.OPTIONS("/api/flows/:uid", optionsHandler())
	srv.DELETE("/api/flows/:uid", authMiddleware(app, deleteFlowHandler(app)))

	srv.GET("/api/sensors", authMiddleware(app, getSensorsHandler(app)))
	srv.POST("/api/sensors", authMiddleware(app, addSensorHandler(app)))
	srv.OPTIONS("/api/sensors", optionsHandler())
	srv.DELETE("/api/sensors/:uid", authMiddleware(app, deleteSensorHandler(app)))
	srv.PUT("/api/sensors/:uid", authMiddleware(app, editSensorHandler(app)))
	srv.OPTIONS("/api/sensors/:uid", optionsHandler())
	...
	srv.OPTIONS("/api/stack", optionsHandler())
	srv.GET("/api/stack", authMiddleware(app, getStackHandler()))

	srv.OPTIONS("/api/destinations", optionsHandler())
	srv.GET("/api/destinations", authMiddleware(app, getDestinationsHandler(app)))
