...
func getServerHandler(app *App) air.Handler {
	return func(req *air.Request, res *air.Response) error {
		return res.WriteJSON(getSensors(app))
	}
}

func getServerConnection(app *App) []*model.ServerConnection {
	serverConnection := app.getServerConnection()

	return serverConnection
}

func connectServerHandler(app *App) air.Handler {
	return func(req *air.Request, res *air.Response) error {
...
func disconnectServerHandler(app *App) air.Handler {
	return func(req *air.Request, res *air.Response) error {
